...
| **Default aligned** | **Part** | **Chapter**  | **Sub Chapter**  |
|-----------------|:-------------|:---------------:|---------------:|
...
| First body part |    |        | Understanding How Linux Distributions Emerged    |
| Second line     |           | **1**      | Choosing Ubuntu or another Debian distribution            |
| Third line      |          |              | Understanding how companies make money with Linux            |
...
| Third line      |          |              | GNU transitions UNIX to freedom            |
| First body part |    |        | Understanding How Linux Distributions Emerged    |
| Second line     |           | **2**      | Choosing Ubuntu or another Debian distribution            |
| Third line      |          |              | Understanding how companies make money with Linux            |
| First body part |    |        | Becoming Red Hat certified    |
| Second line     |           | **strong**      | Choosing a Red Hat distribution            |
| Third line      |          |              | Finding Professional Opportunities with Linux Today            |
